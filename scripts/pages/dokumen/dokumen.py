...
#         self.cbo_template_keterangan.addItems(static_values['TEMPLATE_KETERANGAN'].get(selected_dokumen, []))
...
#                     tingkat=self.parent.quoted_tingkat,
...
#             self.path = f"{DIREKTORI_DOKUMEN}/{target}/{self.namafile}"
