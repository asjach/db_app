...
#   HELPERS METHOD
    ...
    def create_filename(self):
        ...
        tapel = self.cbo_tapel.currentText()
        kelas = self.cbo_kelas.currentText()
        tingkat = f'Tingkat {self.cbo_tingkat.currentText() }' if self.cbo_kelas.currentText() == '' else ''
        filename_nilai = f"Blanko Nilai {kegiatan} {tingkat}{kelas} {jenjang}.xlsx"
        filename_walas = f"Blanko Catatan Walas {kegiatan} {tingkat}{kelas} {jenjang}.xlsx"
