...
class Widget_Image_Viewer(Ui_Image_Viewer_Form, QWidget):
    ...
    #     self.zoomX = (
    #         self.qlabel_image.parent().width() / self.qlabel_image.parent().height()
    #     )
    #     self.position = [0, 0]
    #     self.qimage_scaled = self.qimage.scaled(
    #         int(self.qlabel_image.width()),
    ...
    # def browse_and_load_image(self, line_edit=None, default_folder: str = None):
    #     """open image using QFileDialog and display it in qlabel_image"""
    ...
    #         self.qimage_scaled = self.qimage.scaled(
    #             self.qlabel_image.parent().width(),
