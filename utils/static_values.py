...
TEMPLATE_KETERANGAN = {
                    ...
                    "Nilai Ijazah": ('', 'JENJANG', 'Rapor', 'SD', 'SMP', 'SMA'),
                    "Transkrip": ('', 'S1', 'S2', 'S3', ),
...
KETERANGAN = {
                    ...
                    "Akta": ('Kelahiran', 'Pendirian', 'Notaris'),
                    "KTP":('Pribadi', 'Orang Tua', 'Ayah', 'Ibu'),
                    "Ijazah": ('RA', 'TK', 'SD', 'MI','MD', 'MTs', 'SMP', 'MLN', 'MA', 'SMA', 'D1', 'D2', 'D3', 'D4', 'S1', 'S2', 'S3'),
...
PILIHAN_JENJANG = ('', 'MI-MD', 'MI Saja', 'MD Saja')
...
ULANGAN = ['PAS', 'AS Ganjil',  'PAT', 'AS Genap', 'UKK', 'UAS', 'ASS', 'ASAS', 'ASAT', 'PSAS', 'PSAT']
