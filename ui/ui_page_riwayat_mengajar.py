...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.tbl_riwayat_mengajar, 2, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.cbo_kelas, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.cbo_guru, 1, 1, 1, 1)
