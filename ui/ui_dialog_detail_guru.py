...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_save_detail.setMinimumSize(QSize(80, 24))
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 581, 854))
        self.gridLayout_4 = QGridLayout(self.scrollAreaWidgetContents)
        self.gridLayout_4.setObjectName(u"gridLayout_4")
        self.gridLayout_4.setHorizontalSpacing(0)
        self.gridLayout_4.setVerticalSpacing(20)
        self.gridLayout_4.setContentsMargins(0, 0, 0, 0)
        self.widget_51 = QWidget(self.scrollAreaWidgetContents)
        self.widget_51.setObjectName(u"widget_51")
        self.gridLayout_6 = QGridLayout(self.widget_51)
        self.gridLayout_6.setObjectName(u"gridLayout_6")
        self.gridLayout_6.setHorizontalSpacing(5)
        self.gridLayout_6.setVerticalSpacing(0)
        self.gridLayout_6.setContentsMargins(5, 5, 5, 5)
        self.label_13 = QLabel(self.widget_51)
        ...
        self.widget_3 = QWidget(self.widget_51)
        ...
        self.gridLayout_4.addWidget(self.widget_51, 2, 0, 1, 1)

        self.widget_datadiri = QWidget(self.scrollAreaWidgetContents)
        self.widget_datadiri.setObjectName(u"widget_datadiri")
        self.widget_datadiri.setStyleSheet(u"")
        self.gridLayout_5 = QGridLayout(self.widget_datadiri)
        self.gridLayout_5.setObjectName(u"gridLayout_5")
        self.gridLayout_5.setHorizontalSpacing(5)
        self.gridLayout_5.setVerticalSpacing(0)
        self.gridLayout_5.setContentsMargins(5, 5, 5, 5)
        self.widget = QWidget(self.widget_datadiri)
        self.widget.setObjectName(u"widget")

        self.gridLayout_5.addWidget(self.widget, 3, 2, 1, 1)

        self.label_62 = QLabel(self.widget_datadiri)
        self.label_62.setObjectName(u"label_62")

        self.gridLayout_5.addWidget(self.label_62, 2, 0, 1, 1)

        self.line_tgl_lahir = QLineEdit(self.widget_datadiri)
        self.line_tgl_lahir.setObjectName(u"line_tgl_lahir")
        self.line_tgl_lahir.setMinimumSize(QSize(0, 24))

        self.gridLayout_5.addWidget(self.line_tgl_lahir, 5, 1, 1, 1)

        self.cbo_jk = QComboBox(self.widget_datadiri)
        self.cbo_jk.setObjectName(u"cbo_jk")
        self.cbo_jk.setMinimumSize(QSize(0, 24))

        self.gridLayout_5.addWidget(self.cbo_jk, 3, 1, 1, 1)

        self.label_5 = QLabel(self.widget_datadiri)
        self.label_5.setObjectName(u"label_5")

        self.gridLayout_5.addWidget(self.label_5, 5, 0, 1, 1)

        self.label_4 = QLabel(self.widget_datadiri)
        self.label_4.setObjectName(u"label_4")

        self.gridLayout_5.addWidget(self.label_4, 4, 0, 1, 1)

        self.label_3 = QLabel(self.widget_datadiri)
        self.label_3.setObjectName(u"label_3")

        self.gridLayout_5.addWidget(self.label_3, 3, 0, 1, 1)

        self.line_tmp_lahir = QLineEdit(self.widget_datadiri)
        self.line_tmp_lahir.setObjectName(u"line_tmp_lahir")
        self.line_tmp_lahir.setMinimumSize(QSize(0, 24))

        self.gridLayout_5.addWidget(self.line_tmp_lahir, 4, 1, 1, 1)

        self.label_6 = QLabel(self.widget_datadiri)
        self.label_6.setObjectName(u"label_6")

        self.gridLayout_5.addWidget(self.label_6, 3, 3, 1, 1)

        self.line_nik = QLineEdit(self.widget_datadiri)
        self.line_nik.setObjectName(u"line_nik")
        self.line_nik.setMinimumSize(QSize(0, 24))

        self.gridLayout_5.addWidget(self.line_nik, 3, 4, 1, 1)

        self.label_40 = QLabel(self.widget_datadiri)
        ...
        self.gridLayout_4.addWidget(self.widget_datadiri, 0, 0, 1, 1)

        self.widget_alamat = QWidget(self.scrollAreaWidgetContents)
        self.widget_alamat.setObjectName(u"widget_alamat")
        self.widget_alamat.setStyleSheet(u"")
        self.gridLayout_8 = QGridLayout(self.widget_alamat)
        ...
        self.gridLayout_4.addWidget(self.widget_alamat, 1, 0, 1, 1)
        ...
        self.line_no_hp = QLineEdit(self.widget_6)
        self.line_no_hp.setObjectName(u"line_no_hp")
        self.line_no_hp.setMinimumSize(QSize(0, 24))

        self.gridLayout_7.addWidget(self.line_no_hp, 1, 1, 1, 1)

        self.line_email_pribadi = QLineEdit(self.widget_6)
        self.line_email_pribadi.setObjectName(u"line_email_pribadi")
        self.line_email_pribadi.setMinimumSize(QSize(0, 24))
        ...
        self.label_42 = QLabel(self.widget_6)
        ...
        self.gridLayout_14 = QGridLayout(self.widget_71)
        ...
        self.gridLayout_15 = QGridLayout(self.widget_7)
        ...
        self.cbo_status_kawin = QComboBox(self.widget_7)
        self.cbo_status_kawin.setObjectName(u"cbo_status_kawin")
        self.cbo_status_kawin.setMinimumSize(QSize(0, 24))

        self.gridLayout_15.addWidget(self.cbo_status_kawin, 1, 0, 1, 1)

        self.line_nama_istri_suami = QLineEdit(self.widget_7)
        self.line_nama_istri_suami.setObjectName(u"line_nama_istri_suami")
        self.line_nama_istri_suami.setMinimumSize(QSize(0, 24))

        self.gridLayout_15.addWidget(self.line_nama_istri_suami, 1, 1, 1, 1)

        self.label_77 = QLabel(self.widget_7)
        self.label_77.setObjectName(u"label_77")

        self.gridLayout_15.addWidget(self.label_77, 0, 2, 1, 1)

        self.line_jumlah_anak = QLineEdit(self.widget_7)
        self.line_jumlah_anak.setObjectName(u"line_jumlah_anak")
        self.line_jumlah_anak.setMinimumSize(QSize(0, 24))

        self.gridLayout_15.addWidget(self.line_jumlah_anak, 1, 2, 1, 1)


        self.gridLayout_9.addWidget(self.widget_7, 1, 0, 1, 1)

        self.tbl_daftar_keluarga = QTableWidget(self.widget_8)
        self.tbl_daftar_keluarga.setObjectName(u"tbl_daftar_keluarga")

        self.gridLayout_9.addWidget(self.tbl_daftar_keluarga, 2, 0, 1, 1)
        ...
        self.widget_10 = QWidget(self.widget3)
        ...
        self.tbl_pendidikan_formal = QTableWidget(self.widget_10)
        self.tbl_pendidikan_formal.setObjectName(u"tbl_pendidikan_formal")

        self.gridLayout_11.addWidget(self.tbl_pendidikan_formal, 1, 0, 1, 1)


        self.gridLayout_16.addWidget(self.widget_10, 1, 0, 1, 1)


        self.gridLayout_12.addWidget(self.widget3, 0, 1, 1, 1)
        ...
        QWidget.setTabOrder(self.cbo_search_by, self.line_search)
        QWidget.setTabOrder(self.line_search, self.cbo_daftar_guru)
        QWidget.setTabOrder(self.cbo_daftar_guru, self.tabWidget)
        QWidget.setTabOrder(self.tabWidget, self.scrollArea)
        QWidget.setTabOrder(self.scrollArea, self.line_id_guru)
        QWidget.setTabOrder(self.line_id_guru, self.line_nama_lengkap)
        QWidget.setTabOrder(self.line_nama_lengkap, self.cbo_jk)
        QWidget.setTabOrder(self.cbo_jk, self.line_tmp_lahir)
        QWidget.setTabOrder(self.line_tmp_lahir, self.line_tgl_lahir)
        QWidget.setTabOrder(self.line_tgl_lahir, self.line_ayah)
        QWidget.setTabOrder(self.line_ayah, self.line_ibu_kandung)
        QWidget.setTabOrder(self.line_ibu_kandung, self.line_nik)
        QWidget.setTabOrder(self.line_nik, self.line_niat_npa)
        QWidget.setTabOrder(self.line_niat_npa, self.line_no_kk)
        QWidget.setTabOrder(self.line_no_kk, self.cbo_agama)
        QWidget.setTabOrder(self.cbo_agama, self.cbo_status_tmp_tinggal)
        QWidget.setTabOrder(self.cbo_status_tmp_tinggal, self.line_alamat)
        QWidget.setTabOrder(self.line_alamat, self.line_kodepos)
        QWidget.setTabOrder(self.line_kodepos, self.line_rt)
        QWidget.setTabOrder(self.line_rt, self.line_rw)
        QWidget.setTabOrder(self.line_rw, self.line_kel_desa)
        QWidget.setTabOrder(self.line_kel_desa, self.line_kecamatan)
        QWidget.setTabOrder(self.line_kecamatan, self.line_kab_kota)
        QWidget.setTabOrder(self.line_kab_kota, self.line_provinsi)
        QWidget.setTabOrder(self.line_provinsi, self.cbo_jarak)
        QWidget.setTabOrder(self.cbo_jarak, self.cbo_transportasi)
        QWidget.setTabOrder(self.cbo_transportasi, self.cbo_waktu_tempuh)
        QWidget.setTabOrder(self.cbo_waktu_tempuh, self.cbo_status_kepegawaian)
        QWidget.setTabOrder(self.cbo_status_kepegawaian, self.line_nuptk)
        QWidget.setTabOrder(self.line_nuptk, self.line_npk)
        QWidget.setTabOrder(self.line_npk, self.line_peg_id)
        QWidget.setTabOrder(self.line_peg_id, self.line_tmt_guru)
        QWidget.setTabOrder(self.line_tmt_guru, self.line_tmt_pegawai)
        QWidget.setTabOrder(self.line_tmt_pegawai, self.line_no_hp)
        QWidget.setTabOrder(self.line_no_hp, self.line_email_pribadi)
        QWidget.setTabOrder(self.line_email_pribadi, self.line_email_hebat)
        QWidget.setTabOrder(self.line_email_hebat, self.line_password_hebat)
        QWidget.setTabOrder(self.line_password_hebat, self.line_bpjs)
        QWidget.setTabOrder(self.line_bpjs, self.line_npwp)
        QWidget.setTabOrder(self.line_npwp, self.cbo_goldar)
        QWidget.setTabOrder(self.cbo_goldar, self.line_nama_pemilik_rekening)
        QWidget.setTabOrder(self.line_nama_pemilik_rekening, self.line_norek)
        QWidget.setTabOrder(self.line_norek, self.line_nama_bank)
        QWidget.setTabOrder(self.line_nama_bank, self.cbo_status_sertifikasi)
        QWidget.setTabOrder(self.cbo_status_sertifikasi, self.cbo_jenjang_sertifikasi)
        QWidget.setTabOrder(self.cbo_jenjang_sertifikasi, self.line_mapel_sertifikasi)
        QWidget.setTabOrder(self.line_mapel_sertifikasi, self.line_kode_mapel_sertifikasi)
        QWidget.setTabOrder(self.line_kode_mapel_sertifikasi, self.line_nopes_sertifikasi)
        QWidget.setTabOrder(self.line_nopes_sertifikasi, self.line_lptk_sertifikasi)
        QWidget.setTabOrder(self.line_lptk_sertifikasi, self.line_no_sertifikasi)
        QWidget.setTabOrder(self.line_no_sertifikasi, self.line_tgl_lulus_sertifikasi)
        QWidget.setTabOrder(self.line_tgl_lulus_sertifikasi, self.line_tahun_sertifikasi)
        QWidget.setTabOrder(self.line_tahun_sertifikasi, self.line_model_sertifikasi)
        QWidget.setTabOrder(self.line_model_sertifikasi, self.line_jalur_sertifikasi)
        QWidget.setTabOrder(self.line_jalur_sertifikasi, self.line_naungan_sertifikasi)
        QWidget.setTabOrder(self.line_naungan_sertifikasi, self.cbo_status_kawin)
        QWidget.setTabOrder(self.cbo_status_kawin, self.line_nama_istri_suami)
        QWidget.setTabOrder(self.line_nama_istri_suami, self.line_jumlah_anak)
        QWidget.setTabOrder(self.line_jumlah_anak, self.tbl_daftar_keluarga)
        QWidget.setTabOrder(self.tbl_daftar_keluarga, self.tbl_pendidikan_formal)
        QWidget.setTabOrder(self.tbl_pendidikan_formal, self.btn_save_detail)
