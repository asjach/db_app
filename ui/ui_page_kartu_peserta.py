...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_14 = QLabel(self.left_pane)
        self.label_14.setObjectName(u"label_14")

        self.gridLayout.addWidget(self.label_14, 1, 2, 1, 1)

        self.cbo_kegiatan = QComboBox(self.left_pane)
        self.cbo_kegiatan.setObjectName(u"cbo_kegiatan")
        self.cbo_kegiatan.setMinimumSize(QSize(100, 24))

        self.gridLayout.addWidget(self.cbo_kegiatan, 1, 3, 1, 1)

        self.horizontalSpacer_7 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout.addItem(self.horizontalSpacer_7, 1, 1, 1, 1)

        self.btn_show_left = QPushButton(self.left_pane)
        self.btn_show_left.setObjectName(u"btn_show_left")
        self.btn_show_left.setMinimumSize(QSize(24, 24))
        self.btn_show_left.setMaximumSize(QSize(24, 24))
        self.btn_show_left.setCheckable(True)
        self.btn_show_left.setChecked(True)

        self.gridLayout.addWidget(self.btn_show_left, 1, 0, 1, 1)

        self.tbl_daftar_peserta = QTableWidget(self.left_pane)
        ...
        self.gridLayout.addWidget(self.tbl_daftar_peserta, 2, 0, 1, 4)


        self.gridLayout_6.addWidget(self.left_pane, 0, 0, 1, 1)
        ...
        self.right_pane = QWidget(Form)
        self.right_pane.setObjectName(u"right_pane")
        self.right_pane.setMinimumSize(QSize(400, 0))
        self.gridLayout_5 = QGridLayout(self.right_pane)
        self.gridLayout_5.setObjectName(u"gridLayout_5")
        self.gridLayout_5.setVerticalSpacing(20)
        self.gridLayout_5.setContentsMargins(0, 9, 0, 9)
        self.widget_10 = QWidget(self.right_pane)
        ...
        self.x_nama.setButtonSymbols(QAbstractSpinBox.PlusMinus)
        ...
        self.gridLayout_3.addWidget(self.x_nama, 3, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.size_nama, 3, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.x_ttl, 4, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.y_ttl, 4, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.size_ttl, 4, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.radio_nopes, 5, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.radio_nama, 3, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.radio_nisn, 8, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.radio_kelas, 6, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.radio_no_induk, 7, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.x_no_induk, 7, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.y_kelas, 6, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.size_nisn, 8, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.y_nisn, 8, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.y_nopes, 5, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.x_nisn, 8, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.x_kelas, 6, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.x_nopes, 5, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.size_kelas, 6, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.size_nopes, 5, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.y_no_induk, 7, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.size_no_induk, 7, 3, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.spin_presisi.sizePolicy().hasHeightForWidth())
        self.spin_presisi.setSizePolicy(sizePolicy1)
        self.spin_presisi.setMinimumSize(QSize(0, 24))
        ...
        self.gridLayout_3.addWidget(self.spin_presisi, 1, 3, 1, 1)
        ...
        self.label_26.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)
        ...
        self.widget_8 = QWidget(self.right_pane)
        ...
        self.gridLayout_5.addWidget(self.widget_8, 10, 0, 1, 1)

        self.widget_6 = QWidget(self.right_pane)
        ...
        sizePolicy1.setHeightForWidth(self.spin_lebar.sizePolicy().hasHeightForWidth())
        self.spin_lebar.setSizePolicy(sizePolicy1)
        ...
        self.gridLayout_2.addWidget(self.spin_lebar, 1, 1, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.spin_horizontal.sizePolicy().hasHeightForWidth())
        self.spin_horizontal.setSizePolicy(sizePolicy1)
        ...
        self.gridLayout_2.addWidget(self.spin_horizontal, 1, 4, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.spin_tinggi.sizePolicy().hasHeightForWidth())
        self.spin_tinggi.setSizePolicy(sizePolicy1)
        ...
        self.gridLayout_2.addWidget(self.spin_tinggi, 2, 1, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.spin_vertikal.sizePolicy().hasHeightForWidth())
        self.spin_vertikal.setSizePolicy(sizePolicy1)
        ...
        self.gridLayout_2.addWidget(self.spin_vertikal, 2, 4, 1, 1)
        ...
        self.cbo_fonts = QComboBox(self.widget_6)
        self.cbo_fonts.setObjectName(u"cbo_fonts")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.cbo_fonts.sizePolicy().hasHeightForWidth())
        self.cbo_fonts.setSizePolicy(sizePolicy2)
        self.cbo_fonts.setMinimumSize(QSize(0, 24))
        self.cbo_fonts.setEditable(False)

        self.gridLayout_2.addWidget(self.cbo_fonts, 3, 1, 1, 4)


        self.gridLayout_5.addWidget(self.widget_6, 1, 0, 1, 1)

        self.widget_11 = QWidget(self.right_pane)
        ...
        self.gridLayout_11.addWidget(self.label_4, 0, 4, 1, 1)

        self.cbo_jenis = QComboBox(self.widget_11)
        self.cbo_jenis.addItem("")
        self.cbo_jenis.addItem("")
        self.cbo_jenis.setObjectName(u"cbo_jenis")
        sizePolicy2.setHeightForWidth(self.cbo_jenis.sizePolicy().hasHeightForWidth())
        self.cbo_jenis.setSizePolicy(sizePolicy2)
        self.cbo_jenis.setMinimumSize(QSize(0, 24))
        self.cbo_jenis.setEditable(False)

        self.gridLayout_11.addWidget(self.cbo_jenis, 1, 0, 1, 1)
        ...
        self.cbo_kertas.setMinimumSize(QSize(100, 24))
        self.cbo_kertas.setEditable(False)

        self.gridLayout_11.addWidget(self.cbo_kertas, 0, 2, 1, 1)

        self.cbo_orientasi = QComboBox(self.widget_11)
        self.cbo_orientasi.addItem("")
        self.cbo_orientasi.addItem("")
        self.cbo_orientasi.setObjectName(u"cbo_orientasi")
        self.cbo_orientasi.setMinimumSize(QSize(100, 24))
        self.cbo_orientasi.setEditable(False)

        self.gridLayout_11.addWidget(self.cbo_orientasi, 1, 2, 1, 1)

        self.label_24 = QLabel(self.widget_11)
        self.label_24.setObjectName(u"label_24")
        self.label_24.setMinimumSize(QSize(80, 24))
        ...
        self.spin_margin_left = QDoubleSpinBox(self.widget_11)
        ...
        self.gridLayout_11.addWidget(self.spin_margin_left, 0, 5, 1, 1)

        self.label_27 = QLabel(self.widget_11)
        self.label_27.setObjectName(u"label_27")
        self.label_27.setMinimumSize(QSize(0, 24))
        self.label_27.setFont(font1)
        self.label_27.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)

        self.gridLayout_11.addWidget(self.label_27, 1, 4, 1, 1)

        self.spin_margin_top = QDoubleSpinBox(self.widget_11)
        ...
        self.gridLayout_11.addWidget(self.spin_margin_top, 1, 5, 1, 1)


        self.gridLayout_5.addWidget(self.widget_11, 0, 0, 1, 1)

        self.widget_5 = QWidget(self.right_pane)
        ...
        self.gridLayout_10.addWidget(self.radio_foto, 0, 0, 1, 1)

        self.label_22 = QLabel(self.widget_5)
        self.label_22.setObjectName(u"label_22")
        self.label_22.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_10.addWidget(self.label_22, 0, 4, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.h_foto, 1, 5, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.y_foto, 1, 3, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.x_foto, 0, 3, 1, 1)

        self.label_21 = QLabel(self.widget_5)
        self.label_21.setObjectName(u"label_21")
        self.label_21.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_10.addWidget(self.label_21, 1, 2, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.w_foto, 0, 5, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.widget_5, 6, 0, 1, 1)

        self.widget_12 = QWidget(self.right_pane)
        ...
        self.gridLayout_5.addWidget(self.widget_12, 7, 0, 1, 1)

        self.widget_9 = QWidget(self.right_pane)
        ...
        self.gridLayout_9.addWidget(self.btn_browse, 0, 1, 1, 1)
        ...
        self.plain_background.setMaximumSize(QSize(16777215, 40))

        self.gridLayout_9.addWidget(self.plain_background, 1, 0, 1, 2)


        self.gridLayout_5.addWidget(self.widget_9, 2, 0, 1, 1)

        self.verticalSpacer = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_5.addItem(self.verticalSpacer, 9, 0, 1, 1)


        self.gridLayout_6.addWidget(self.right_pane, 0, 2, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_show_left.setText(QCoreApplication.translate("Form", u"<", None))
        ...
        self.label_4.setText(QCoreApplication.translate("Form", u"Left Margin", None))
        ...
        self.label_27.setText(QCoreApplication.translate("Form", u"Top Margin", None))
